...
describe('Custom commands', () => {
    ...
    it("handling links", () => {
       ...
       //clicking on the mac laptop.
        // cy.get("div[class='item-grid'] div:nth-child(2) 
        // div:nth-child(1) div:nth-child(2) 
        // h2:nth-child(1) a:nth-child(1)").click();
    ...
    it("overwriting existing command", () => {
       ...
       //using custom command
       //contains is over written custom command.
       cy.clickLink("APPLE MACBOOK PRO 13-inch");
       cy.get("div[class='product-name'] h1").should('have.text','Apple MacBook Pro 13-inch');
    })
    ...
    it.only("Login command", () => {
        ...
        cy.loginapp("testing@gmail.com","test123");  // custom command
           //assert if we have logged into the account.
