...
it("csslocators", () => {
    ...
    //cy.get("input#search_query_top").type("T-Shirts") // id   tag is present like this
  ...
  cy.get(".search_query[name='search_query']").type("T-Shirts")    //  class attribute   tag is optional
